 ...
 *
 * @param {object} `layerConfig` An object containing `name`, `path`, and
 *    `props` keys. See `quattroAdminLevels` in `./master`.
 */
...
/**
 * Respond to messages from the parent process, `./master`.
 */
